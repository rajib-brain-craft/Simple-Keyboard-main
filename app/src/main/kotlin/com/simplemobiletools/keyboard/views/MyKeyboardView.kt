...
class MyKeyboardView @JvmOverloads constructor(context: Context, attrs: AttributeSet?, defStyleRes: Int = 0) :
    ...
    interface OnNewKeyboardSetListener {
        /**
         * Called everytime a keyboard is set
         */
        fun onNewKeyboardSet()
    }

    interface OnVisibilityChangedListener {
        /**
         * Called everytime visibility is changed
         */
        fun onVisibilityChanged(visibility: Int)
    }

    var onKeyboardActionListener: OnKeyboardActionListener? = null
    var onNewKeyboardSetListener: OnNewKeyboardSetListener? = null
    ...
    override fun onVisibilityChanged(changedView: View, visibility: Int) {
        ...
        if (visibility == VISIBLE) {
            ...
            if (changedView == popUpKeyboardView) {
    ...
    fun setKeyboard(keyboard: MyKeyboard) {
        ...
        onNewKeyboardSetListener?.onNewKeyboardSet()
    }

    fun vibrateIfNeeded() {
        Utils.vibrateIfNeeded(this)
    }
    ...
    private fun detectAndSendKey(index: Int, x: Int, y: Int, eventTime: Long) {
        if (index != NOT_A_KEY && index < mKeys.size) {
            ...
            onKeyboardActionListener!!.onKey(key.code)
    ...
    private fun onLongPress(popupKey: MyKeyboard.Key, me: MotionEvent): Boolean {
        ...
        if (popupKeyboardId != 0) {
            ...
            if (mMiniKeyboardContainer == null) {
                ...
                mMiniKeyboard = mMiniKeyboardContainer!!.findViewById<View>(R.id.popUpKeyboardView) as MyKeyboardView
        ...
        when (action) {
            MotionEvent.ACTION_POINTER_DOWN -> {
                ...
                if (secondKeyCode != null) {
                    onKeyboardActionListener!!.onPress(secondKeyCode)
                }
            ...
            MotionEvent.ACTION_DOWN -> {
                ...
                if (mPopupParent.id != R.id.popUpKeyboardView) {
